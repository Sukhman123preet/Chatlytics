  ...
  return (
    <nav className="relative flex justify-between items-center w-full max-w-7xl mx-auto py-6 px-6 z-10">
      ...
      <div className="flex space-x-8">
        <a href="#home" className="relative text-white/90 text-lg font-medium hover:text-white transition-all duration-300 group pb-2">
          Home
          <span className="absolute -bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 group-hover:w-full transition-all duration-300"></span>
        </a>
        <a href="#about" className="relative text-white/90 text-lg font-medium hover:text-white transition-all duration-300 group pb-2">
          About Us
          <span className="absolute -bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 group-hover:w-full transition-all duration-300"></span>
        </a>
      </div>
          ...
          <>
            <button
              ...
              className="px-4 py-2 rounded-xl text-white font-semibold
                ...
                transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-white/50">
              Login
            </button>
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl text-white font-semibold
                ...
                hover:-translate-y-0.5 shadow-lg shadow-blue-500/20
                hover:shadow-xl hover:shadow-purple-500/30 transition-all
                duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-purple-400">
              Sign Up
            </button>
          </>
        )}
